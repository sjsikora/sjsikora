...
- 🌳 [**IDS Solar Bench**](https://github.com/IDS-Solar-Bench/backserver): I was the Director of Software Integration for UBCO's IDS (Innovate, Design, Sustain) Solar Bench Project. Specifically, my role in the Solar Bench project is to retrieve data from a microcontroller and display it on a website. My work is on the back burner while the physical bench gets approved and built.
